...
<main>
    ...
    <section class="sec-1-about">
        <div class="container">
            <div class="about">
                <div class="block-item">
                    <div class="sec1-text">
                        <h1>Фотосессия в Москве и Московской области</h1>
                        <p>Я – Свиридов Степан, профессиональный фотограф, работаю в разных районах Москвы и Московской области. </p>
                        <p>Также я снимаю свадьбы, love-story, семейные фотосессии и принимаю участие в коммерческих съёмках (съемка объектов недвижимости и товаров для успешной продажи).</p>
                        <div class="sec1-contacts">
                            <p>+7-916-393-69-61 WhatsApp</p>
                ...
                <div class="block-item sec1-photo">
                    <!--                    <img src="images/Stepan-photo.jpg" class="about_img">-->
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="sec-2">
        <div class="operations">  <!-- блок с переключаемым контентом -->
            ...
            <div class="operations__content operations__content--1 operations__content--active">
                <div class="container portfolio">
                    <div class="portfolio-block">
                        <div class="portfolio-img-up portrait-1"></div>
                        <div class="portfolio-img-up portrait-2"></div>
                    </div>
                    <div class="portfolio-block">
                        <div class="portfolio-img-down portrait-3"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="operations__content operations__content--2">
                <div class="container portfolio">
                    <div class="portfolio-block">
                        <div class="portfolio-img-up reportage-1"></div>
                        <div class="portfolio-img-up reportage-2"></div>
                    </div>
                    <div class="portfolio-block">
                        <div class="portfolio-img-down reportage-3"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="operations__content operations__content--3">
                <div class="container portfolio">
                    <div class="portfolio-block">
                        <div class="portfolio-img-up peysage-1"></div>
                        <div class="portfolio-img-up peysage-2"></div>
                    </div>
                    <div class="portfolio-block">
                        <div class="portfolio-img-down peysage-3"></div>
                    </div>
                </div>
            </div>
            <!-- зона контента 4 -->
            <div class="operations__content operations__content--4">
                <div class="container portfolio">
                    <div class="portfolio-block">
                        <div class="portfolio-img-up interior-1"></div>
                        <div class="portfolio-img-up interior-2"></div>
                    </div>
                    <div class="portfolio-block">
                        <div class="portfolio-img-down interior-3"></div>
                    </div>
                </div>
            </div>
...
<!--                    <th>Заказать</th>-->
                ...
                <tr>
                    <td>3 часа</td>
                    <td>Студийная фотосъёмка, репортажная съемка для мероприятия.</td>
                    <td>4500 руб</td>
<!--                    <td><a href="#" class="prices-btn">Заказать</a></td>-->
                </tr>
                <tr>
                    <td>Целый день</td>
                    <td>Свадебный день или целый съёмочный день любого мероприятия. Съемка происходит по заранее оговоренному плану.</td>
                    <td>24000 руб</td>
<!--                    <td><a href="#" class="prices-btn">Заказать</a></td>-->
                </tr>
                <tr>
                    <td>Индивидуально</td>
                    <td>Обсуждается индивидуально, исходя из ТЗ заказчика, готов к длительным командировкам.</td>
                    <td>По запросу</td>
<!--                    <td><a href="#" class="prices-btn">Заказать</a></td>-->
                </tr>
            </table>
